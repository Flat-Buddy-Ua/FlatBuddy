		...
		>
			<div className="login-popup__card">
				...
				<div className="login-popup__header">
					...
					<p className="login-popup__subtitle">{t('login_popup.subtitle')}</p>
				</div>

				<div className="login-popup__form">
					<div>
						<div className="login-popup__field-label">{t('login_popup.email')}</div>
						<SmartBox
							fieldName="email"
							formState={formState}
						...
						>
							<SmartInput
								placeholder={t('login_popup.email')}
								name="login_e_mail"
								type="email"
							/>
						</SmartBox>
					...
					<div>
						<div className="login-popup__field-label">{t('login_popup.password')}</div>
						<SmartBox
							fieldName="password"
							formState={formState}
							setFormState={setFormState}
							mywidth="100%"
						>
							<PasswordInput name="login_pass_word" placeholder={t('login_popup.password')} hideInfo />
						</SmartBox>
					</div>
				</div>
				...
				<div className="login-popup__actions">
					<SubmitBtn
						...
						btntext={isSubmitting ? t("login_popup.login_btn_loading") : t("login_popup.login_btn")}
					/>
				</div>
			</div>
		</div>
