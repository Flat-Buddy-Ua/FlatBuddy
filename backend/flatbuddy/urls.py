...
from user.views.UserPriorityView import MePriorityView
...
urlpatterns = [
    ...
    path('api/profile/priorities/', MePriorityView.as_view(),  name='profile-priorities'),
    path('api/matches/',            MyMatchListView.as_view(), name='my-matches'),
