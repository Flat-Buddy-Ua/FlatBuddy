# Manually written migration: add Кривий Ріг city + 7 districts,
# and convert UserProfile.hobbies from IntegerField to ArrayField.
...
CITY_CHOICES = [
    ...
    (29, 'Кременчук'), (30, 'Конотоп'), (31, 'Умань'), (32, 'Яремче'),
    (33, 'Кривий Ріг'),
]
...
DISTRICT_CHOICES = [
    ...
    (104, 'Інгульський'), (105, 'Корабельний'), (106, 'Центральний'),
    (107, 'Південно-Західний'),
    (108, 'Покровський'), (109, 'Тернівський'), (110, 'Саксаганський'),
    (111, 'Довгинцівський'), (112, 'Металургійний'), (113, 'Центрально-Міський'),
    (114, 'Інгулецький'),
]


HOBBY_CHOICES = [
    (1, 'Фітнес / Тренажерний зал'), (2, 'Біг / Легка атлетика'), (3, 'Йога / Медитація'),
    (4, 'Велоспорт'), (5, 'Командні види спорту'), (6, 'Бойові мистецтва'),
    (7, 'Походи / Гори'), (8, 'Музика / Гра на інструментах'), (9, 'Фотографія / Відео'),
    (10, 'Малювання / Дизайн'), (11, 'Рукоділля / DIY'), (12, 'Письменництво / Блогінг'),
    (13, 'Відеоігри'), (14, 'Настільні ігри'), (15, 'Кіно та Серіали'),
    (16, 'Аніме / Манга'), (17, 'Книги / Література'), (18, 'Кулінарія / Випічка'),
    (19, 'Подорожі / Туризм'), (20, 'Домашні тварини'), (21, 'Кімнатні рослини'),
    (22, 'Волонтерство'), (23, 'Технології / Програмування'), (24, 'Вивчення мов'),
    (25, 'Мода / Стиль'),
]
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='destination',
            field=models.IntegerField(blank=True, choices=CITY_CHOICES, null=True),
        ),
        migrations.AlterField(
            model_name='userhousing',
            name='preferred_districts',
            field=django.contrib.postgres.fields.ArrayField(
                base_field=models.IntegerField(blank=True, choices=DISTRICT_CHOICES, null=True),
                blank=True,
                default=list,
                size=10,
            ),
        ),
        # Postgres has no implicit cast int -> int[]; do the column type change via raw SQL
        # so existing values are wrapped into single-element arrays instead of being lost.
        migrations.RunSQL(
            sql=[
                (
                ...
                (
                    'ALTER TABLE "user_profile" '
                    'ALTER COLUMN "hobbies" TYPE integer[] '
                    'USING CASE WHEN "hobbies" IS NULL THEN ARRAY[]::integer[] '
                    'ELSE ARRAY["hobbies"] END'
                ),
                (
                    'ALTER TABLE "user_profile" '
                ...
                (
                    'UPDATE "user_profile" SET "hobbies" = \'{}\' WHERE "hobbies" IS NULL'
                ),
                (
                    'ALTER TABLE "user_profile" '
            ...
            reverse_sql=[
                ...
                (
                    'ALTER TABLE "user_profile" '
                    'ALTER COLUMN "hobbies" TYPE integer '
                    "USING CASE WHEN array_length(\"hobbies\", 1) > 0 "
                    'THEN "hobbies"[1] ELSE NULL END'
                ),
            ],
            state_operations=[
                migrations.AlterField(
